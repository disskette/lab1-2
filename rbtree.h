...
public:
    ...
    int searchAll(const char* key, Partner* result, int maxSize) const {
        ...
        // Поскольку дубликаты уходят вправо при вставке, все они образуют непрерывный правый хвост от самого левого совпадения.
    ...
    RBNode* successor(RBNode* x) const {
        ...
        RBNode* y = x->parent; // поднимаюсь к родителю
